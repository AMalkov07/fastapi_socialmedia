...
def login(user_credentials: schemas.UserLogin, db: Session = Depends(database.get_db)):
    ...
    # remember that this line returns the entire row of data in which the condition is met, not jus the column of the specified condition (equivalent to SELECT * FROM user WHERE email = user_credentials.email)
